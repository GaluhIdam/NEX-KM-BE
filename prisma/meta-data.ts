...
export const SuperAdmin: UserListDTO = {
    ...
    personalBirthPlace: 'GARUT',
    personalBirthDate: '1996-09-09',
    personalGrade: null,
...
export enum permissionENUM {
    ...
    GET_USER_IN_ROLE = 'GET_USER_IN_ROLE',
    CREATE_USER_IN_ROLE = 'CREATE_USER_IN_ROLE',
    DELETE_USER_IN_ROLE = 'DELETE_USER_IN_ROLE',
